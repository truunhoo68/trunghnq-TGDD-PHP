   ...
   <table class="data-table table nowrap text-center">
      <thead>
        <tr>
          ...
          <th class="table-plus">Giá</th>
          <th class="table-plus">Ảnh</th>
            <th class="table-plus" >Số lượng</th>
          <th colspan="2" class="table-plus">Hành động</th>
  ...
  $user = $_SESSION['user'][1];
		...
		if(mysqli_num_rows($result)){
            ...
            <td> <form action="" method="post" > <input class="form-control" type="number"  name="sl" value="<?php echo  $a['so_luong']?>" style="width: 60px;height: 60px"> </form> </td>
                    <td> <a href='thanh_toan.php?id_sp=<?php echo $a['id_sp'] ?>'> <img src="img/tt.png" alt="" width="25" height="25">Thanh toán</a> </td>
            <td><a onclick="return confirm('Xác nhận xóa !')" href="xoa_gio.php?id=<?php echo $a['id'] ?>"> <img src="img/xoa1.png" alt="" width="25px" height="25px" >Delete</a></td>
		</tr>
		<?php
			}
		}
