			...
			<div class="header-search">
				<form method="get">
					...
					<div class="form-group mb-0">
						...
						<input type="text" class="form-control search-input" name="tk" placeholder="Search Here">
						<div class="dropdown">
							
									<button style="position: absolute; top: 1px; right: 0px;height: 44px; border-radius: 0 5px 5px 0" name="sm_tk" class="btn btn-primary">Search</button>
...
<div class="main-container">
	<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
                <h2 class="h4 pd-20">Quản Trị Sản Phẩm</h2>
			<a href="them.php"><button class="btn btn-success" style="margin-left: 10px;">Product New</button></a>
						...
						<tr>
							...
							<td>
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
									<?php echo "<a class='dropdown-item' href='/DuAnMau/web1/chitietsp.php?masp=".$num['ma_sp']."'><i class='dw dw-view'></i> View</a> " ?> 
				<?php echo "<a class='dropdown-item' href='sua.php?masp=".$num['ma_sp']."'><i class='dw dw-edit'></i> Edit</a> " ?> 	
						
				<a href="<?php echo "xoa.php?masp=".$num['ma_sp']."" ?>" class="dropdown-item"  onclick="return confirm('Bạn sẽ không thể khôi phục! Xác nhận xóa.')"><i class='dw dw-delete-3'></i>  Delete</a>
									</div>
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
									<?php echo "<a class='dropdown-item' href='/Du_an_1/chitietsp.php?id=".$num['id']."'><i class='dw dw-view'></i> View</a> " ?> 
				<?php echo "<a class='dropdown-item' href='sua.php?id=".$num['id']."'><i class='dw dw-edit'></i> Edit</a> " ?> 	
						
				<a href="<?php echo "xoa.php?id=".$num['id']."" ?>" class="dropdown-item"  onclick="return confirm('Bạn sẽ không thể khôi phục! Xác nhận xóa.')"><i class='dw dw-delete-3'></i>  Delete</a>
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="footer-wrap pd-20 mb-20 card-box">
				Copyright by Trương Tuấn <a href="https://www.facebook.com/Tuan.Real.OMG.1704" target="_blank">Contact</a>
			</div>
		</div>
</div>
				...
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-edit2"></span><span class="mtext">Quản Trị Sản Phẩm</span>
						</a>
						<ul class="submenu">
							<li><a href="index.php" class="active"> Tất Cả Sản Phẩm </a></li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="qtcmt.php">Quản Lí Commment</a></li>
