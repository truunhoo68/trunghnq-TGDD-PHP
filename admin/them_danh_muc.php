...
<div class="main-container" >
	<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
                <h2 class="h4 pd-20">Thêm Danh Mục Mới</h2>
                <hr>
                <div class="container" style="width: 500px">
				<form action="" method="POST" enctype="multipart/form-data">
    <b>Tên Danh Mục</b> <input type="text" name="ten" class="form-control" placeholder="Tên danh mục" > <br>
    <b>Ảnh</b> <input type="file" name="anh" class="form-control" placeholder="Ảnh hiển thị" > <br>


    <input type="submit" name="sm" value="thêm" class="btn btn-primary">
    </form>
    <span style="display: block; color: red;"> <?php echo $thongbao ?> </span>
			</div>
			</div>
