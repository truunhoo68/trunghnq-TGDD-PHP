            ...
            <div class="col-md-6 ">
                <nav style="width: 900px;">
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link actives" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Chưa xác nhận</a>
                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Đã xác nhận</a>
                ...
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="">
                                    ...
                                    <div class="card-box mb-30" style="width: 1000px">
                                        <table class="data-table table nowrap text-center">
                                            ...
                                            $i=0;
                                            $sql = "SELECT * FROM don_hang WHERE trang_thai = 'Chờ xác nhận' ";
                                            ...
                                            if(mysqli_num_rows($result)){
                                                while($num =  mysqli_fetch_assoc($result)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-plus" >
                                                            <?php echo "<b style='color: red'>".$num['trang_thai']."</b>"?>
                                                        </td>
                                                        <td class="table-plus">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <?php echo "<a class='dropdown-item' href='chi_tiet_don_hang.php?id=".$num['id']."'><i class='dw dw-view'></i> View</a> " ?>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            ...
                                            echo '<b class="alert-success">Có <b style="color: red">'.$i.'</b> đơn hàng</b>';
                                ...
                                <div class="">
                                    ...
                                    <div class="card-box mb-30" style="width: 1000px">
                                        <table class="data-table table nowrap text-center">
                                            ...
                                            require_once "ketnoi.php";
                                            $i=0;
                                            $sql = "SELECT * FROM don_hang WHERE trang_thai = 'Đã xác nhận' ";
                                            $result = mysqli_query($con,$sql);
                                            if(mysqli_num_rows($result)){
                                                while($num =  mysqli_fetch_assoc($result)){
                                                    $i++;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-plus" >
                                                            <?php echo "<b style='color: blue'>".$num['trang_thai']."</b>"?>
                                                        </td>
                                                        <td class="table-plus">
                                                            <div class="dropdown">
                                                                <a class="btn btn-link font-24 p-0 line-height-1 no-arrow dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <?php echo "<a class='dropdown-item' href='chi_tiet_don_hang_2.php?id=".$num['id']."'><i class='dw dw-view'></i> View</a> " ?>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="">
                                    ...
                                    <div class="card-box mb-30" style="width: 1000px">
                                        <table class="data-table table nowrap text-center">
                                            ...
                                            require_once "ketnoi.php";
                                            $i=0;
                                            $sql = "SELECT * FROM don_hang WHERE trang_thai = 'Đã giao hàng' ";
                                            $result = mysqli_query($con,$sql);
                                            if(mysqli_num_rows($result)){
                                                while($num =  mysqli_fetch_assoc($result)){
                                                    $i++;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-plus" >
                                                            <?php echo "<b style='color: green'>".$num['trang_thai']."</b>"?>
                                                        </td>
                                                        <td class="table-plus">
                                                            <div class="dropdown">
                                                                <a class="btn btn-link font-24 p-0 line-height-1 no-arrow dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <?php echo "<a class='dropdown-item' href='chi_tiet_don_hang_3.php?id=".$num['id']."'><i class='dw dw-view'></i> View</a> " ?>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                    ...
                    <div class="tab-pane fade" id="nav-suc" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="container">
                            <div class="row">
