...
$thongbao = '';
$arr = [];
if(isset($_POST['sm']) && isset($_FILES['anh'])){
    $name = $_POST['ten'];
    $anh = $_FILES['anh']['name'];
...
if(empty($anh)){
	require "ketnoi.php";
	$sql = "SELECT * FROM danh_muc WHERE id = '$ma'";
...
$id = $_GET['id'];
        $sql = "UPDATE danh_muc SET ten_danh_muc = '$name', anh = '$anh' WHERE id = $id";
...
<div class="main-container" >
	<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
                <h2 class="h4 pd-20"> UPDATE Danh Mục</h2>
                <hr>
				...
				$ma = $_GET['id'];
						...
						if(mysqli_num_rows($result)){
							while($num =  mysqli_fetch_assoc($result)){
								$ten = $num['ten_danh_muc'];
								$anh = $num['anh'];
							?>
				<form action="" method="POST" enctype="multipart/form-data">
                <b>Tên Danh Mục</b> <input type="text" name="ten" class="form-control" placeholder="Tên danh mục" value="<?php echo $ten ?>" > <br>
    <b>Ảnh</b> <input type="file" name="anh" class="form-control" placeholder="Ảnh hiển thị" > 
	<img width="65px" height="65px" src="img/<?php echo $anh ?>">
	<br>
