...
if(empty($user)){
    $arr[] = "bạn chưa nhập user";
}
if(empty($pass)){
    $arr[] = "bạn chưa nhập pass";
}
...
<div class="main-container" >
    ...
    <b>Tên Admin </b> <input type="text" name="ten_admin" class="form-control" placeholder="Nhập tên Admin . . ."><br>
    <b>Tên Đăng nhập</b>  <input type="text" name="user"  class="form-control" placeholder="Nhập tên đăng nhập"><br>
    <b>Password</b>  <input type="text" name="pass"  class="form-control" placeholder="Nhập password"> <br>
				...
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="them_user.php" class="active" >Thêm User</a></li>
						</ul>
					</li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
