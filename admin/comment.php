	...
	<div class="pd-ltr-20">
		...
		if(mysqli_num_rows($result)){
			while($num = mysqli_fetch_assoc($result)){
				?>
				<td> <img src="img/<?php echo $num['anh_sp'] ?>" alt="" width="150" height="150"></td>
				<h4 style="margin-top: 20px;" > <?php echo $num['ten_sp'] ?> </h4>
				<?php
			}
		}
				?>
		<table border="1" class="data-table table nowrap text-center">
			<tr>
		...
		$i = 0;
		$id = $_GET['id'];
		$sql = "SELECT * FROM danh_gia WHERE id_sp = '$id'   ORDER BY id DESC ";
		$result = mysqli_query($con,$sql);
		if(mysqli_num_rows($result)){
			while($num = mysqli_fetch_assoc($result)){
				$i++;
				...
				<td>	
				<?php echo $num['noi_dung'] ?>
				</td>
				<td>
					<?php
					
				echo "<a class='dropdown-item' href='xoa_cmt.php?id_sp=".$num['id_sp']."&id=".$num['id']."'><i class='dw dw-delete'></i> Delete</a> " 
			?>	</td>
			</tr>
			<?php
			}
		...
		<br>
		<hr>
		<td style="margin-top: 20px;display: block;" >	
				<?php echo "<b style='color:red;'>Có ".$i.' Bình Luận </b>'  ?>
				</td>
		</table>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu"  >
							<li><a href="qtcmt.php"  class="active" >Quản Lí Comment</a></li>
