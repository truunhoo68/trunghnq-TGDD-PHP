...
<div class="main-container" >
    ...
    <div class="card-box mb-30">
                <h2 class="h4 pd-20">Quản Trị Slide</h2>
			<a href="them_slide.php"><button class="btn btn-success" style="margin-left: 10px;">Thêm Ảnh Slide</button></a>
				<table class="data-table table nowrap text-center">
					...
					<tbody style="text-align: center;">
						...
						<tr>
							<td class="table-plus">
							<img src="img/<?php echo $num['anh_slide'] ?>" alt="" width="70" height="70"> 
                            </td>
                            <td class="table-plus">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
				<?php echo "<a class='dropdown-item' href='sua_silde.php?id=".$num['id']."'><i class='dw dw-edit'></i> Edit</a> " ?> 	
						
				<a href="<?php echo "xoa_slide.php?id=".$num['id']."" ?>" class="dropdown-item"  onclick="return confirm('Bạn sẽ không thể khôi phục! Xác nhận xóa.')"><i class='dw dw-delete-3'></i>  Delete</a>
									</div>
                                </div>
                                </td>
							</td>
