...
if(empty($arr)){
    ...
    echo "upload thành công <br/>";
        ...
        $sql = "INSERT INTO san_pham (ten_sp,gia_sp,loai_sp,so_luong,anh_sp,mo_ta,trang_thai) VALUES ('$name','$gia','$loai','$soluong','$anh','$mota','$tt')";
...
<div class="main-container" >
	<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
                <h2 class="h4 pd-20">Thêm Sản Phẩm Mới</h2>
                <hr>
                <div class="container" style="width: 500px">
				<form action="" method="POST" enctype="multipart/form-data">
    <b>Tên Sản Phẩm </b> <input type="text" name="tensp" class="form-control" placeholder="Nhập tên sản phẩm . . ."><br>
    <b>Giá Sản Phẩm</b>  <input type="text" name="gia"  class="form-control" placeholder="Nhập giá sản phẩm"><br>
   ...
   <b> Số Lượng</b> <input type="number" name="soluong" class="form-control" value="1"><br>
   <b> Ảnh Sản Phẩm</b> <input type="file" name="upload" class="form-control"><br>
    <b>Mô Tả</b> <input type="text" name="mota" class="form-control" placeholder="Nhập mô tả sản phẩm"><br>
   <b> Trạng Thái</b> <select name="tt" id="" class="form-control"><br>
        <option value="Còn hàng">Còn hàng</option>
        <option value="Hết hàng">Hết hàng</option>
    </select><br>
    <input type="submit" name="sm" value="thêm" class="btn btn-primary">
    </form>
