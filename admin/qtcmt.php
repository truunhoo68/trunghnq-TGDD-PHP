...
<div class="main-container" >
	...
	if(mysqli_num_rows($resul)){
		while($cmt = mysqli_fetch_assoc($resul)){
$i++;
		}
	}
	?>
			...
			<div class="card-box mb-30">
				<a  style="margin-top: 20px !important;margin-left: 400px;" class="btn btn-primary">
				<span  style=" color: white;">Có Tất Cả </span><?php echo '<b style="color: #f1e900";>'.$i.'</b>'."<span style='color:white;'> Bình Luận </span>" ?> 
				</a>
				<hr>
				<?php
				require 'ketnoi.php';?>
				<table class="data-table table nowrap text-center">
					...
					<?php
						$sql = "SELECT DISTINCT id_sp  FROM danh_gia INNER JOIN san_pham ON danh_gia.id_sp=san_pham.id";
						$resu = mysqli_query($con,$sql);
						if(mysqli_num_rows($resu)){
							while($a = mysqli_fetch_assoc($resu)){	
								$id = $a['id_sp'];
								$sl=0;
					...
					if(mysqli_num_rows($resul)){
						while($a = mysqli_fetch_assoc($resul)){							
							...
							<td> <img src="img/<?php echo $a['anh_sp'] ?>" alt="" width="50" height="50"></td>
							<td>	<div class="dropdown">
									...
									<?php
										...
										echo "<a class='dropdown-item' href='/Du_an_1/admin/comment.php?id=".$a['id']."'><i class='dw dw-view'></i> Xem Comment</a> ";
										echo "<a class='dropdown-item' href='/Du_an_1/chitietsp.php?id=".$a['id']."'><i class='dw dw-view'></i> Xem Chi Tiết</a> " ?> 
									</div>
								</div>
							</td>
						</tr>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-edit2"></span><span class="mtext">Quản Lí Comment</span>
						</a>
						<ul class="submenu">
					...
					<li class="dropdown">
						<a href="/DuAnMau/web1/index.php" class="dropdown-toggle">
