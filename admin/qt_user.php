...
<div class="main-container" >
	<div class="pd-ltr-20">
        ...
        <div class="container">     <a href="them_user.php"  class="btn btn-primary" style="color:white;">Thêm User</a></div>
                <hr>
                <div class="container">
              <table class="data-table table nowrap text-center" border='1'>
...
$i=0;
                ...
                if(mysqli_num_rows($result)){
                    while($num =  mysqli_fetch_assoc($result)){
                        ...
                        $role = $num['role'];
                        if($role==0){
                            $quyen = "<span style='color:red;'>Quản trị cao cấp</span>";
                        }else if($role==1){
                            $quyen = "<span style='color:green;'>Quản trị viên</span>";
                        }else{
                            $quyen = "khách hàng";
                        }
                ?> <tr class="table-plus d-table-row">
                ...
                <td> <?php echo $num['user']; ?></td>
                <td> <?php echo $quyen; ?></td>
			<td>	<a href="<?php echo "xoa_user.php?id=".$num['id']."" ?>" class="dropdown-item"  onclick="return confirm('Bạn sẽ không thể khôi phục! Xác nhận xóa.')"><i class='dw dw-delete-3'></i>  Delete</a></td>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="qt_user.php" class="active" >Tất cả User</a></li>
